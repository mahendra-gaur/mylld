...
import com.example.cricbuzz.inning.InningDetails;
...
public class Match {
    ...
    public Match(@NonNull final Team teamA, @NonNull final Team teamB, @NonNull final Date matchDate,
                 @NonNull final String venue, @NonNull final MatchType matchType) {
        this.teamA = teamA;
        this.teamB = teamB;
