...
import com.example.cricbuzz.match.Match;
import com.example.cricbuzz.matchtype.MatchType;
import com.example.cricbuzz.matchtype.impl.T20MatchType;
import com.example.cricbuzz.player.Person;
...
public class Main {
    ...
    private PlayerDetails addPlayer(String name, PlayerType playerType) {
        PlayerDetails playerDetails = new PlayerDetails(name, playerType);
